  ...
  modes: {
    'shift':{
      ...
      draw: function(g,i){
        ...
        pt.drawLine(g,{
      		a: {x: 5 + mg.cellSize - mg.cellWidth,y:5 + y},
      		b: {x: 5 + mg.cellSize + mg.cellWidth,y:5 + y}
      	})
      	pt.drawLine(g,{
      		a: {x: 5 + mg.cellSize,y:5 + y - mg.cellWidth},
      		b: {x: 5 + mg.cellSize,y:5 + y + mg.cellWidth}
      	})
      }
    },
    'newCell':{
...
mg.Cell = class {
  ...
  draw(g){
    ...
    g.strokeStyle = 'white'
    g.rect(p.x,p.y,mg.cellSize,mg.cellSize)
    g.stroke()
  }
}
